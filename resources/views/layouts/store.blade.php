    ...
    <header>
        ...
        <div class="category-strip">
            <div class="category-strip-inner">
                ...
                <a href="{{ route('products.index', ['category' => 'hoa-sinh-nhat']) }}" class="category-pill">Hoa sinh
                    nhật</a>
                <a href="{{ route('products.index', ['category' => 'hoa-khai-truong']) }}" class="category-pill">Hoa
                    khai trương</a>
                ...
                fetch('{{ route('chat.send') }}', {
                    ...
                    .then(function(r) {
                        return r.json().then(function(data) {
                            if (!r.ok) throw new Error(data.reply || data.message || 'Lỗi ' + r
                                .status);
                            return data;
                        }).catch(function(e) {
                    ...
                    .catch(function(err) {
                        setTyping(false);
                        appendBotMsg(err && err.message ? err.message :
                            'Đang bận, bạn thử lại sau hoặc gọi Hotline 1900 1345 nhé!');
                    });
            });
        })();
    </script>
