        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div class="admin-card p-5 text-sm">
                ...
                <div class="space-y-1.5">
                    ...
                    @endif
                    <p><span class="font-medium text-gray-600">Tài khoản:</span>
                        {{ optional($order->user)->email ?? 'Khách lẻ' }}</p>
                </div>
                @if ($order->notes)
            ...
            <div class="admin-card p-5 text-sm">
                ...
                <div class="space-y-1.5">
                    ...
                    <p><span class="font-medium text-gray-600">Tổng tiền:</span> <span
                            class="font-semibold">{{ number_format($order->total_amount, 0, ',', '.') }} đ</span></p>
                </div>
                <div class="mt-4 pt-4 border-t border-gray-100">
                    ...
                    ">
                            Hiện tại:
                            {{ match ($order->status) {'pending' => 'Chờ xử lý','confirmed' => 'Đã xác nhận','shipping' => 'Đang giao','completed' => 'Hoàn thành','cancelled' => 'Đã hủy',default => $order->status} }}
                        </span>
                    </p>
                </div>
            </div>
