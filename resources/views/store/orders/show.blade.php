...
@section('content')
    ...
    <div style="display:flex;flex-wrap:wrap;gap:1.5rem;align-items:flex-start;margin-bottom:1.5rem;">
        <div style="flex:1 1 260px;min-width:0;border-radius:.9rem;border:1px solid #e3e3e0;padding:1rem;background:#fff;font-size:.9rem;">
    ...
    <div style="border-radius:.9rem;border:1px solid #e3e3e0;overflow:hidden;background:#fff;font-size:.9rem;margin-bottom:1.5rem;">
