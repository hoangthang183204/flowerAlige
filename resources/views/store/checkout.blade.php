        ...
        <div style="display:flex;flex-wrap:wrap;gap:2rem;align-items:flex-start;">
                ...
                <form action="{{ route('checkout.place') }}" method="POST">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" name="customer_name"
                            value="{{ old('customer_name', $user->name ?? ($lastOrder->customer_name ?? '')) }}" required
                            class="form-input">
                        @error('customer_name')
                    ...
                    <div class="form-row">
                        <div class="form-field">
                            ...
                            <input type="text" name="customer_phone"
                                value="{{ old('customer_phone', $user->phone ?? ($lastOrder->customer_phone ?? '')) }}"
                        ...
                        <div class="form-field">
                            ...
                            <input type="email" name="customer_email"
                                value="{{ old('customer_email', $user->email ?? ($lastOrder->customer_email ?? '')) }}"
                                class="form-input">
                    ...
                    <div class="form-field">
                        ...
                        <textarea name="shipping_address" required rows="3" class="form-input">{{ old('shipping_address', $lastOrder->shipping_address ?? '') }}</textarea>
            ...
            <aside style="flex:0 0 260px;max-width:100%;">
                <div style="border-radius:.9rem;border:1px solid #e3e3e0;padding:1rem;background:#fff;">
                    ...
                    <div
                        style="border-top:1px dashed #e3e3e0;margin:.5rem 0 0;padding-top:.5rem;font-size:.95rem;display:flex;justify-content:space-between;">
                        <span>Tổng cộng</span>
